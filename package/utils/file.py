...
def load_pickle(path, verbose=True):
    ...
    # gc.disable() #todo z增加encoding
    with open(path, 'rb') as f:
        ret = pickle.load(f, encoding='iso-8859-1')
    # gc.enable()
    if verbose:
...
def get_files_by_pattern(root, pattern='a/b/*.ext', strip_root=False):
    ...
    #todo 取消修改root为绝对路径
    #root = "/Users/huan/code/PycharmProjects/EANet-master/" + root
    #t = "/Users/huan/code/PycharmProjects/EANet-master/" +root
